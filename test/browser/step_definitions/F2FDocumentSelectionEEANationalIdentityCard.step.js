...
const {PhotoIdSelectionPage, EEAIdentityCardDetailsPageValid, EeaIdentityCardHasExpiryDatePage, EEAIdentityCardAddressCheck, EEAIdentityCardCountrySelectorPage, FindBranch } = require("../pages");

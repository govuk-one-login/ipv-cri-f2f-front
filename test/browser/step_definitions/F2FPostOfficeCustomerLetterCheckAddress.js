...
Given(
  ...
  async function () {
    const postOfficeCustomerLetterCheckAddressPage = new PostOfficeCustomerLetterCheckAddress(
      this.page
    );
...
When(/^the user selects that they want to send the letter to the original address/, async function () {
  const postOfficeCustomerLetterCheckAddressPage = new PostOfficeCustomerLetterCheckAddress(this.page);

...
Then(
  /^the user is routed to the EU DL Has Expiry Entry Screen$/,
  async function () {
...
Then(
  /^the user is routed to the EU DL edit Has Expiry Entry Screen$/,
  async function () {
    const euDrivingLicenceHasExpiryDatePage =
      new EuDrivingLicenceHasExpiryDatePage(await this.page);
...
When(
  /^the user selects yes on the eu driving licence expiry date page$/,
  async function () {
    const euDrivingLicenceHasExpiryDatePage =
      new EuDrivingLicenceHasExpiryDatePage(await this.page);
...
When(
  /^the user selects no on the eu driving licence expiry date page$/,
  async function () {
    const euDrivingLicenceHasExpiryDatePage =
      new EuDrivingLicenceHasExpiryDatePage(await this.page);
...
Then(
  /^the user is routed to the EU DL Expiry Entry Screen$/,
  async function () {
    const euDrivingLicenceDetailsPage = new EuDrivingLicenceDetailsPageValid(
      await this.page
    );
...
Given(
  /^the EU Driving Licence date entered is within accepted expiration window$/,
  async function () {
    const euDrivingLicenceDetailsPage = new EuDrivingLicenceDetailsPageValid(
      await this.page
    );
...
Given(
  /^the user is on the EU Country Code Selection screen$/,
  async function () {}
);

When(
  /^the user clicks the continue button on the EU Driving Licence details page$/,
  async function () {
    const euDrivingLicenceChoice = new EuDrivingLicenceDetailsPageValid(
      await this.page
    );
...
Then(
  /^the user is routed from EU DL Details to the address check page$/,
  async function () {
...
Given(
  /^the user selects a country from the drop down menu$/,
  async function () {
    const countrySelector = new EuDrivingLicenceCountrySelector(
      await this.page
    );
...
When(
  /^the user clicks the continue button on the EU country code page$/,
  async function () {
    const countrySelector = new EuDrivingLicenceCountrySelector(
      await this.page
    );
...
Then(
  /^the user is routed from EU DL country code to Branch Finder Screen$/,
  async function () {

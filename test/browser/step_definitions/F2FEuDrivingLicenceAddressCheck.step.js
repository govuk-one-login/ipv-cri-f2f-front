...
Given(
  /^the user selects Yes, it has my current address on it$/,
  async function () {
...
Given(
  /^the user selects My driving licence does not have my address on it$/,
  async function () {
    const addressCheck = new EuDrivingLicenceAddressCheck(await this.page);
...
Given(
  /^the user selects No, it has my previous address on it$/,
  async function () {
    const addressCheck = new EuDrivingLicenceAddressCheck(await this.page);
...
Given(
  /^no option has been chosen on the EU DL Address Check screen$/,
  async function () {
    const addressCheck = new EuDrivingLicenceAddressCheck(await this.page);
...
When(
  /^the user clicks continue on the EU Driving Licence address check page$/,
  async function () {
    const addressCheck = new EuDrivingLicenceAddressCheck(await this.page);
...
Then(
  /^they are routed to the country code selection screen$/,
  async function () {
...
Then(
  /^they are routed back to the Document Selection screen$/,
  async function () {
...
Then(
  /^the user sees an inline error message displayed on the EU DL address check page$/,
  async function () {
    const addressCheck = new EuDrivingLicenceAddressCheck(await this.page);

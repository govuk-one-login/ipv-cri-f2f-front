...
const { EuDrivingLicenceDetailsPageValid, EuDrivingLicenceDetailsPageInvalidPast, EuDrivingLicenceDetailsPageInvalidFuture, PhotoIdExpiryPage} = require("../pages");

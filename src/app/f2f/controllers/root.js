...
class RootController extends BaseController {
  async saveValues(req, res, next) {
    ...
    try {
      ...
      req.sessionModel.set("addressLine1", "Flat 1")
      req.sessionModel.set("addressLine2", "123 Demo Street")
      req.sessionModel.set("townCity", "Demoville")
      req.sessionModel.set("postalCode", "DM07 3BL")

...
class PhotoIdExpiryController extends BaseController {
  ...
  async saveValues(req, res, next) {
    try {
      logger.info("user selecting new option after photo Id expiry", { req, res });
      req.sessionModel.set("redirect_url", undefined);
      req.sessionModel.set(APP.PHOTO_ID_EXPIRY_OPTIONS.RE_ENTER_DETAILS, undefined);
      req.sessionModel.set(APP.PHOTO_ID_EXPIRY_OPTIONS.CHOOSE_DIFFERENT_PHOTO_ID, undefined);
      req.sessionModel.set(APP.PHOTO_ID_EXPIRY_OPTIONS.PROVE_IDENTITY_ANOTHER_WAY, undefined);
      ...
      switch (action) {
        case APP.PHOTO_ID_EXPIRY_OPTIONS.RE_ENTER_DETAILS: {
          ...
          req.sessionModel.set(APP.PHOTO_ID_EXPIRY_OPTIONS.RE_ENTER_DETAILS, true);
          return next();
        }
        case APP.PHOTO_ID_EXPIRY_OPTIONS.CHOOSE_DIFFERENT_PHOTO_ID: {
          ...
          req.sessionModel.set(APP.PHOTO_ID_EXPIRY_OPTIONS.CHOOSE_DIFFERENT_PHOTO_ID, true);
          return next();
        }
        case APP.PHOTO_ID_EXPIRY_OPTIONS.PROVE_IDENTITY_ANOTHER_WAY: {
          ...
          req.sessionModel.set(APP.PHOTO_ID_EXPIRY_OPTIONS.PROVE_IDENTITY_ANOTHER_WAY, true);
          return next();
        }
      }
